...
const BINARY_NAME = "jstzd";
const FALLBACK_BINARY_PATH = path.join(__dirname, BINARY_NAME);
const BINARY_DISTRIBUTION = {
  darwin_arm64: "jstzd_darwin_arm64",
  linux_x64: "jstzd_linux_x64",
  linux_arm64: "jstzd_linux_arm64",
};
const BINARY_DISTRIBUTION_PACKAGE = {
  darwin_arm64: "jstzd-darwin-arm64",
  linux_arm64: "jstzd-linux-arm64",
  linux_x64: "jstzd-linux-x64",
};
...
async function downloadBinaryFromGithubRelease(binName) {
  const downloadBuffer = await makeRequest(
    `https://github.com/huancheng-trili/jstzd-package/releases/download/${process.env.npm_package_version}/${binName}`,
  );
