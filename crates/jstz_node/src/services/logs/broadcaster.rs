...
use jstz_proto::context::new_account::SmartFunctionAddress;
...
pub struct Broadcaster {
    clients: Mutex<HashMap<SmartFunctionAddress, Vec<Sender<InfallibleSseEvent>>>>, // TODO: Use a read-write lock instead?
}
...
impl Broadcaster {
    ...
    pub async fn new_client(
        &self,
        function_address: SmartFunctionAddress,
    ...
    pub async fn broadcast(&self, function_address: &SmartFunctionAddress, msg: &str) {
        let clients = self.clients.lock().clone();
