 ...
 * @returns {string}
 */
export function sign_operation(operation, secret_key) {
  let deferred3_0;
  let deferred3_1;
  try {
    ...
    const ret = wasm.sign_operation(operation, ptr0, len0);
    var ptr2 = ret[0];
    var len2 = ret[1];
    if (ret[3]) {
      ptr2 = 0;
 ...
 * @returns {string}
 */
export function hash_operation(operation) {
  let deferred2_0;
  let deferred2_1;
  try {
    const ret = wasm.hash_operation(operation);
    var ptr1 = ret[0];
    var len1 = ret[1];
    if (ret[3]) {
      ptr1 = 0;
