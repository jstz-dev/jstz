...
// Strings
impl_to_v8!(for String, Cow<'a, str> where |value, scope| v8::String::new(scope, &value).unwrap());
impl_to_v8!(for &'a str where |value, scope| v8::String::new(scope, value).unwrap());
