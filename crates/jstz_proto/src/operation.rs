...
impl From<&Content> for RevealType {
    fn from(value: &Content) -> Self {
        match *value {
            Content::DeployFunction(_) => RevealType::DeployFunction,
            _ => panic!("reveal not support for type {:?}", value),
        }
    }
}
...
impl Content {
    pub fn new_reval_large_payload(
