...
use crate::context::new_account::SmartFunctionAddress;
...
pub fn log_request_start(address: SmartFunctionAddress, request_id: String) {
...
pub fn log_request_end(address: SmartFunctionAddress, request_id: String) {
