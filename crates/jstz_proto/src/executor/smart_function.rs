...
fn compute_seed(address: &SmartFunctionAddress, operation_hash: &OperationHash) -> u64 {
    let mut seed: u64 = 0;
...
pub mod run {
    ...
    pub fn execute(
        ...
        let sf_address =
            SmartFunctionAddress::from_base58(uri.host().ok_or(Error::InvalidAddress)?)?;
...
pub mod jstz_run {
    ...
    pub fn execute_without_ticketer(
        ...
        let ticketer: SmartFunctionAddress =
