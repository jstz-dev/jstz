...
use jstz_core::{host::HostRuntime, kv::Transaction, Revealer};
...
pub async fn process_and_dispatch_request_impl<Rv: Revealer>(
    ...
    let response = match scheme {
        ...
        Ok(SupportedScheme::Http) | Ok(SupportedScheme::Https) => {
            ...
            // For simulation, we dispatch the oracle request to the host via the reveal channel.
            #[cfg(feature = "simulation")]
...
"#;
    ...
    fn fetch_oracle_request_for_simulation() {
